...
<html lang="en">
  ...
  <body>
        ...
        <div class="accordion" id="accordion">
          ...
          <div class="accordion-item">
            <a href="index.php" class="gap-2 py-2">
              <iconify-icon icon="solar:home-2-bold" width="32px" height="32px" style="color: #1e2463"></iconify-icon>
              <p class="fw-bold" style="color: #1e2463">Dashboard</p>
            </a>
          </div>
          ...
          <div class="accordion-item">
            ...
            <div id="sertifikasi" class="accordion-collapse collapse" data-bs-parent="#accordion">
              <a href="./includes/skema/allSkema.php" class="py-2">
                <p>- All Skema</p>
              </a>
              <a href="./includes/skema/addSkema.php" class="py-2">
                <p>- Add Skema</p>
              </a>
            </div>
          </div>
          ...
          <div class="accordion-item">
            ...
            <div id="peserta" class="accordion-collapse collapse" data-bs-parent="#accordion">
              <a href="./includes/peserta/allPeserta.php" class="py-2">
                <p>- All Peserta</p>
              </a>
              <a href="./includes/peserta/addPeserta.php" class="py-2">
                <p>- Add Peserta</p>
              </a>
            </div>
          </div>
      ...
      <div class="container px-3 px-lg-5 py-5">
        ...
        <div class="row d-flex justify-content-between m-0">
          ...
          <div class="offcanvas offcanvas-start py-5" tab-index="-1" id="offcanvasMenu" aria-labelledby="offcanvasMenuLabel">
              <ul>
                <li>
                  <a href="./includes/skema/allSkema.php"><h1>Skema</h1></a>
                </li>
                <li>
                  <a href="./includes/peserta/allPeserta.php"><h1>Peserta</h1></a>
                </li>
              </ul>
          </div>
        </div>
        ...
        <!-- row -->
        <div class="row row-cols-2 row-cols-md-3 my-5 d-flex justify-content-center">
          <!-- col -->
          <div class="col">
          ...
          <!-- col -->
          <div class="col">
            <div class="card h-100 p-5 px-0 px-lg-5 rounded-5 mt-4 mt-lg-0 pb-4 pb-lg-5">
              <canvas class="w-100" id="chartJenisSkema" aria-label="chart" height="150" width="280"></canvas>
            </div>
          </div>
        </div>
            ...
            <tbody>
              <tr>
                ...
                <td class="d-flex gap-1">
                  <a href="./includes/peserta/updatePeserta.php?Id_peserta=<?php echo $data['Id_peserta']; ?>" class="action rounded-circle" style="background-color: #2ebd59">
    ...
    <script src="./assets/node_modules/chart.js/dist/chart.umd.js" type="text/javascript"></script>
    <script>
      var chart = document.getElementById('chartJenisSkema').getContext('2d');
      var chartJenisSkema = new Chart(chart, {
        type: 'doughnut',
        data: {
          datasets: [
            {
