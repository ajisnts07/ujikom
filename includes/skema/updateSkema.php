  ...
  <body>
    ...
    <main>
      ...
      <div class="container px-3 px-lg-5 py-5">
        ...
        <h2 class="mb-4">Update Skema</h2>
        <!-- form -->
        <div class="card col-sm-5 p-4 p-lg-5 rounded-5">
          <h4>Silahkan isi data!</h4>
          <form action="../../config/skema/updateSkema.php" method="POST" enctype="multipart/form-data">
            <div class="my-3">
              <label for="Kd_skema">Kode Skema</label>
              <input type="text" class="form-control py-2 rounded-3" name="Kd_skema" value="<?php echo $data['Kd_skema']; ?>" readonly/>
            </div>
            <div class="mb-3">
              <label for="Nm_skema">Nama Skema</label>
              <input type="text" class="form-control py-2 rounded-3" name="Nm_skema" autocomplete="off" required autofocus value="<?php echo $data['Nm_skema']; ?>"/>
            </div>
            <div class="mb-3">
              <label for="Jenis">Jenis</label>
              <select class="form-select py-2 rounded-3" name="Jenis" id="Jenis" value="<?php echo $data['Jenis']; ?>">
            ...
            <div class="mb-5">
              ...
              <input type="text" class="form-control py-2 rounded-3" name="Jml_unit" autocomplete="off" required value="<?php echo $data['Jml_unit']; ?>"/>
            </div>
