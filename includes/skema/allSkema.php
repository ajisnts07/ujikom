...
<html lang="en">
  ...
  <body>
    ...
    <div class="sidebar shadow-sm px-0 px-lg-3 d-none d-lg-inline">
      ...
      <div class="container">
        <!-- sidebar-brand -->
        <div class="sidebar-brand text-center py-3 d-none d-lg-inline">
          ...
          <div class="accordion-item">
            ...
            <div id="sertifikasi" class="accordion-collapse collapse show" data-bs-parent="#accordion">
              <a href="./allSkema.php" class="py-2">
                <p class="fw-bold" style="color: #1e2463">- All Skema</p>
              </a>
    ...
    <main>
      ...
      <div class="container px-3 px-lg-5 pt-5">
        ...
        <div class="d-flex">
          <h2>Daftar Skema</h2>
          <a href="./addSkema.php" class="btn primary-btn ms-3 rounded-circle d-flex justify-content-center align-items-center">
            <iconify-icon icon="ic:baseline-plus" width="16" height="16" style="color: #fff"></iconify-icon>
          </a>
        </div>
        <!-- form search -->
        <form action="allSkema.php">
          <!-- input-group -->
          <div class="col-sm-3 ms-auto search my-3 mt-lg-0">
            <div class="input-group">
              <input type="text" class="form-control border-0 rounded-start-pill ps-4" placeholder="Ketik nama skema" name="cari"/>
              <button type="submit" class="submit btn rounded-circle primary-btn d-flex justify-content-center align-items-center p-2 z-3" value="cari">
        ...
        <div class="table-responsive">
          <table class="table table-condesed px-5">
            ...
            <?php
              ...
              if (isset($_GET['cari'])) {
                $cari = $_GET['cari'];
                include '../../config/skema/searchSkema.php';
              } else {
                include '../../config/skema/allSkema.php';
              }
              while (
            ...
            <tbody>
              <tr>
                ...
                <td class="d-flex gap-1">
                  <a href="./updateSkema.php?Kd_skema=<?php echo $data['Kd_skema']; ?>" class="action rounded-circle" style="background-color: #2ebd59">
                    <iconify-icon icon="flowbite:edit-outline" width="16" height="16" style="color: #fff"></iconify-icon>
                  </a>
                  <a href="../../config/skema/deleteSkema.php?Kd_skema=<?php echo $data['Kd_skema']; ?>" class="action rounded-circle" style="background-color: #f16843">
